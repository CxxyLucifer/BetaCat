    ...
    return (
      <WithTheme styles={styles} themeStyles={ListStyles}>
        {itemStyles => {
          ...
          const arrEnum = {
            horizontal: <Icon name={'antDesign|right'} style={itemStyles.Arrow} />,
            down: <Icon name={'antDesign|down'} style={itemStyles.ArrowV} />,
            up: <Icon name={'antDesign|up'} style={itemStyles.ArrowV} />,
          };
