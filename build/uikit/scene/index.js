...
export default class Scene extends React.Component {
    ...
    _renderBody() {
        return (<Body loading={this.props.loading} overflowLoading={this.props.overflowLoading} style={this.props.bodyStyle} onNetworkBack={this.props.onMount}>
        {this.props.children}
      </Body>);
    }
    _renderHeader() {
