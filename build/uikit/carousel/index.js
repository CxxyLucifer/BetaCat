...
class Carousel extends React.Component {
    constructor(props) {
        ...
        this.renderDots = (index) => {
            ...
            const count = this.getChildrenCount(children);
            return (<WithTheme themeStyles={CarouselStyles} styles={this.props.styles}>
        {styles => {
                return pagination({
                    styles,
                    vertical,
    ...
    render() {
        ...
        if (count > 1) {
            ...
            pages = (<View style={pageStyle} onLayout={this.onChildLayout}>
          {children}
        </View>);
        }
        return (<View onLayout={this.onLayout} style={height > 0 ? { height } : {}}>
        {this.renderContent(pages)}
