...
export default class BasicCarouselExample extends React.Component {
    ...
    render() {
        ...
        <View style={{ paddingHorizontal: 15 }}>
          ...
          <Carousel style={styles.wrapper} selectedIndex={2} autoplay infinite afterChange={this.onHorizontalSelectedIndexChange}>
        ...
        <View style={{ paddingHorizontal: 15 }}>
          <Text>vertical</Text>
          <Carousel style={styles.wrapper} selectedIndex={2} autoplay infinite afterChange={this.onVerticalSelectedIndexChange} vertical>
