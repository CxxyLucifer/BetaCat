 ...
 * @private
 */
function _formatUnitStr({ unit, containerUnit, unitConversionNum, buyCount }) {
    if (buyCount > 0) {
        let smallUnit = buyCount % unitConversionNum;
 ...
 * @private
 */
function _getPriceInAreaPrice(buyCount, stepPriceArea) {
