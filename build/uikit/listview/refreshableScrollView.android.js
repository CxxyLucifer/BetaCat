...
export default class RefreshableScrollView extends ScrollView {
    ...
    componentDidMount() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let result = yield AsyncStorage.getItem(DATE_KEY);
                if (result) {
    ...
    renderRefreshHeader() {
        ...
        {this.props.displayDate &&
            <Text style={[defaultHeaderStyles.date, this.props.dateStyle]}>{this.props.dateTitle + this.state.date}
          </Text>}
      </View>);
    }
    renderSpinner() {
        ...
        return (<Animated.Image source={this.props.arrowImageSource} resizeMode="contain" style={[defaultHeaderStyles.arrow,
