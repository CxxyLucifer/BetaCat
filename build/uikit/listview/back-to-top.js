...
export default class BackToTop extends React.Component {
    ...
    render() {
        ...
        if (this.state.isHide) {
            ...
            return (<TouchableOpacity accessible={true} accessibilityLabel={'flat-list:back-to-top'} activeOpacity={0.8} hitSlop={{ top: 10, bottom: 10, left: 0, right: 18 }} onPress={onPress} style={styles.operate}>
